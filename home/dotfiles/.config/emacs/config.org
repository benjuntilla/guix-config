...
(use-package gnus
  ...
  ;; Show the whole INBOX (read and unread), not just unread, so already-seen
  ;; but unarchived mail stays visible.
  (gnus-parameters '(("nnimap\\+fastmail:INBOX" (display . all))))
