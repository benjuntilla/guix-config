...
(use-package origami
  ...
  :bind (("<tab>" . origami-recursively-toggle-node)
         ...
         ("C-c o <backtab>" . origami-toggle-all-nodes)
         ...
         ("C-c o f" . origami-forward-toggle-node)
         ("C-c o b" . origami-backward-toggle-node)
         ("C-c o [" . origami-previous-fold)
         ("C-c o ]" . origami-next-fold)))
#+end_src
